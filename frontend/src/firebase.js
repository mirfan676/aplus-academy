...
const isProductionDomain =
  typeof window !== "undefined" && /(^|\.)aplusacademy\.pk$/i.test(window.location.hostname);

const firebaseConfig = {
  apiKey: import.meta.env.VITE_FIREBASE_API_KEY,
  authDomain: isProductionDomain ? window.location.hostname : import.meta.env.VITE_FIREBASE_AUTH_DOMAIN,
