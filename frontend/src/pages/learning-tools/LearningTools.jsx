...
const LearningTools = () => {
  useSEO({
    ...
    description:
      "Use free student learning tools from A Plus Academy, including an English vocabulary and sentence translator for Urdu, Hindi, Arabic, Spanish, and French.",
      ...
      <Container component="main" sx={{ py: { xs: 5, md: 7 } }}>
        <Grid container spacing={3}>
          <Grid item xs={12} md={7}>
            ...
            >
              <Stack spacing={2.5}>
                <TranslateIcon color="primary" sx={{ fontSize: 38 }} />
                <Box>
                  <Typography component="h2" variant="h4" fontWeight={900} gutterBottom>
                    Learn English Vocabulary
                  </Typography>
                  <Typography color="text.secondary" sx={{ lineHeight: 1.8 }}>
                    Type a word or full sentence in any language and translate it into
                    English, Arabic, Spanish, French, Hindi, and Urdu in one place.
                  </Typography>
                </Box>
          ...
          <Grid item xs={12} md={5}>
            ...
            >
              ...
              <Typography color="text.secondary" sx={{ lineHeight: 1.8 }}>
                This section is ready for more student utilities like grammar practice,
                spelling quizzes, math formula sheets, IELTS word lists, and exam timers.
              </Typography>
            </Paper>
          </Grid>
        </Grid>
