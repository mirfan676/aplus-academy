...
const page = ({
  ...
  heading,
  intro,
  image: imageUrl || image(imageId, imagePath),
  imageAlt,
  primaryCta,
  secondaryCta,
...
const cityHero = (city) => `/landing-images/local-seo/${city}-home-tutors.png`;
...
const areaLandingPage = ({
  ...
  page({
    ...
    title,
    description,
    eyebrow: `${focusLabel} ${area}`,
    heading,
    intro,
    imageUrl: cityHero(city.toLowerCase()),
    imageAlt,
    primaryCta,
    secondaryCta: whatsappCta,
    highlights: [
      `${focusLabel} in ${area}`,
      `Popular nearby areas: ${nearbyAreas.slice(0, 3).join(", ")}`,
      `Common requests: ${subjects.slice(0, 3).join(", ")}`,
    ],
    sections: [
      {
        title: `${focusLabel} in ${area} for practical academic support`,
        body: `Families in ${area} often look for tutors who can fit school timings, travel routes, and the student's actual weak areas instead of offering generic lessons. A Plus Academy helps parents and students discuss the class level, subject combination, preferred teaching style, and whether home tuition or online tutoring will work better for routines in ${area} and the nearby ${nearbyAreas.join(", ")} areas.`,
      },
      {
        title: `Subjects families in ${area} usually ask for`,
        body: `${focusLabel} requests in ${area} commonly include ${subjects.join(", ")}. These requests often come from families connected with schools and colleges around ${schools.join(", ")}, or from students preparing for board exams, Cambridge papers, entry tests, spoken English improvement, or Quran learning with regular follow-up at home.`,
      },
      {
        title: `What makes a better tutor match in ${area}`,
        body: `The best tutor match for ${area} depends on more than just subject knowledge. Parents usually want punctuality, lesson planning, safe home visits, clear communication, and visible progress after the first few classes. Students often need help with homework, revision, weekly tests, past-paper practice, confidence building, and exam strategy, so the tutor selection should match the learner's pace instead of forcing a one-size-fits-all plan.`,
      },
    ],
    popularLinks,
    faqs: [
      [
        `Do you provide ${focusKey} in ${area}?`,
        `Yes, A Plus Academy can check availability for ${focusKey.toLowerCase()} in ${area}, subject to tutor schedule, subject demand, and timing.`,
      ],
      [
        `Can students in ${area} choose online classes instead?`,
        `Yes, students in ${area} can request online tutoring if home tuition is not the right fit for their schedule or subject.`,
      ],
      [
        `How should I request a tutor for ${area}?`,
        `Share the subject, class, school or board, area, preferred timings, and whether you want home tuition or online classes so the team can guide the next step.`,
      ],
    ],
  });

export const localAreaSeoPages = {
  oLevelGardenTownLahore: areaLandingPage({
    slug: "o-levels-home-tutors-garden-town-lahore",
    city: "Lahore",
    ...
    intro:
      "Connect with O Level tutors in Garden Town Lahore for syllabus coverage, topical revision, past-paper practice, and one-to-one Cambridge exam preparation at home or online.",
    nearbyAreas: ["Model Town", "Kalma Chowk", "Faisal Town", "Muslim Town"],
    schools: ["LGS", "Beaconhouse", "City School", "Divisional Public School"],
    subjects: ["Maths", "Physics", "Chemistry", "Biology", "English", "Accounting"],
    imageAlt: "Tutor helping an O Level student in a Lahore study setting",
    primaryCta: { label: "Find O Level Tutors", to: "/teachers?location=Lahore&subject=O%20Level" },
    popularLinks: [
      { label: "O and A Level support", to: "/o-a-level" },
      { label: "Home tutors Lahore", to: "/home-tutors-lahore" },
      { label: "English tutor Lahore", to: "/english-tutor-lahore" },
    ],
  }),
  homeTutorsDhaLahore: areaLandingPage({
    slug: "home-tutors-dha-lahore",
    city: "Lahore",
    area: "DHA Lahore",
    focusKey: "home tutors",
    focusLabel: "Home Tutors",
    title: "Home Tutors in DHA Lahore | Verified Home Tuition",
    description:
      "Find home tutors in DHA Lahore for school subjects, Matric, FSc, O Level, A Level, IELTS, Quran, and spoken English with home or online classes.",
    heading: "Home tutors in DHA Lahore for school, Cambridge, Quran and language support",
    intro:
      "Families in DHA Lahore can request home tutors for school subjects, board exams, Cambridge classes, Quran, English, IELTS, and university-level support.",
    nearbyAreas: ["DHA Phase 1", "DHA Phase 5", "Cantt", "Askari"],
    schools: ["LGS DHA", "Beaconhouse", "Roots", "International School Lahore"],
    subjects: ["Matric", "FSc", "O Level", "A Level", "IELTS", "Quran"],
    imageAlt: "Private home tutor with student in a DHA Lahore home",
    primaryCta: { label: "Find DHA Tutors", to: "/teachers?location=Lahore" },
    popularLinks: [
      { label: "Verified tutors Pakistan", to: "/verified-tutors-pakistan" },
      { label: "Female tutors Lahore", to: "/female-home-tutor-lahore" },
      { label: "IELTS tutor Pakistan", to: "/ielts-tutor-pakistan" },
    ],
  }),
  femaleTutorsJoharTownLahore: areaLandingPage({
    slug: "female-home-tutors-johar-town-lahore",
    city: "Lahore",
    ...
    intro:
      "Parents in Johar Town Lahore can request female home tutors for primary classes, middle school, Matric, FSc, Quran, spoken English, and concept-building lessons at home.",
    nearbyAreas: ["Wapda Town", "Canal View", "Township", "Shaukat Khanum side"],
    schools: ["LACAS", "LGS JT", "The City School", "Allied School"],
    subjects: ["Primary classes", "Matric", "FSc", "Quran", "Spoken English", "Homework help"],
    imageAlt: "Female tutor teaching a student at home in Johar Town Lahore",
    primaryCta: { label: "Find Female Tutors", to: "/teachers?location=Lahore" },
    popularLinks: [
      { label: "Female home tutor Lahore", to: "/female-home-tutor-lahore" },
      { label: "K-12 support", to: "/k-12" },
      { label: "Quran tutor with Tajweed", to: "/quran-tutor-with-tajweed" },
    ],
  }),
  homeTutorsF11Islamabad: areaLandingPage({
    slug: "home-tutors-f-11-islamabad",
    city: "Islamabad",
    area: "F-11 Islamabad",
    focusKey: "home tutors",
    focusLabel: "Home Tutors",
    title: "Home Tutors in F-11 Islamabad | Home and Online Tuition",
    description:
      "Find home tutors in F-11 Islamabad for school subjects, O Level, A Level, Matric, FSc, IELTS, English, and university tutoring.",
    heading: "Home tutors in F-11 Islamabad for school subjects, Cambridge exams and English learning",
    intro:
      "Students in F-11 Islamabad can request home and online tutors for school studies, Cambridge preparation, spoken English, IELTS, and university support.",
    nearbyAreas: ["F-10", "E-11", "G-11", "Golra side"],
    schools: ["Roots Millennium", "Beaconhouse", "Westminster", "The City School"],
    subjects: ["School subjects", "O Level", "A Level", "IELTS", "English", "University support"],
    imageAlt: "Tutor teaching a student at home in Islamabad",
    primaryCta: { label: "Find Islamabad Tutors", to: "/teachers?location=Islamabad" },
    popularLinks: [
      { label: "Online tutors Pakistan", to: "/online-tutors-pakistan" },
      { label: "IELTS", to: "/ielts" },
      { label: "Study abroad support", to: "/study-abroad" },
    ],
  }),
  quranTutorsBahriaIslamabad: areaLandingPage({
    slug: "quran-tutors-bahria-town-islamabad",
    city: "Islamabad",
    ...
    intro:
      "Families in Bahria Town Islamabad can request Quran tutors for children and adults who need Nazra, Tajweed correction, fluency, and regular recitation practice.",
    nearbyAreas: ["Phase 4", "Phase 7", "Civic Center side", "DHA side"],
    schools: ["Roots", "Beaconhouse", "Bahria schools", "private academies"],
    subjects: ["Nazra", "Tajweed", "Makharij", "Quran reading", "Duas", "Revision"],
    imageAlt: "Quran tutor teaching Tajweed in an Islamabad home",
    primaryCta: { label: "Find Quran Tutors", to: "/teachers?location=Islamabad&subject=Quran" },
    popularLinks: [
      { label: "Quran and Tajweed", to: "/quran-tajweed" },
      { label: "Quran tutor with Tajweed", to: "/quran-tutor-with-tajweed" },
      { label: "Verified tutors", to: "/verified-tutors-pakistan" },
    ],
  }),
  oLevelTutorsDhaIslamabad: areaLandingPage({
    slug: "o-level-home-tutors-dha-islamabad",
    city: "Islamabad",
    area: "DHA Islamabad",
    focusKey: "O Level home tutors",
    focusLabel: "O Level Tutors",
    ...
    intro:
      "A Plus Academy helps students in DHA Islamabad find O Level tutors for topical revision, yearly past papers, concept building, and Cambridge exam preparation.",
    nearbyAreas: ["DHA Phase 1", "DHA Phase 2", "Bahria", "Giga Mall side"],
    schools: ["Roots", "Beaconhouse", "Westminster", "The City School"],
    subjects: ["Maths", "Physics", "Chemistry", "Biology", "Business", "Economics"],
    imageAlt: "O Level tutor guiding a Cambridge student in DHA Islamabad",
    primaryCta: { label: "Find O Level Tutors", to: "/teachers?location=Islamabad&subject=O%20Level" },
    popularLinks: [
      { label: "O and A Level", to: "/o-a-level" },
      { label: "A Level tutors Pakistan", to: "/a-level-tutors-pakistan" },
      { label: "Home tutors F-11 Islamabad", to: "/home-tutors-f-11-islamabad" },
    ],
  }),
  homeTutorsDhaKarachi: areaLandingPage({
    slug: "home-tutors-dha-karachi",
    city: "Karachi",
    area: "DHA Karachi",
    focusKey: "home tutors",
    focusLabel: "Home Tutors",
    ...
    intro:
      "Families in DHA Karachi can request home tutors for primary classes, board exams, Cambridge subjects, Quran, IELTS, spoken English, and university-level guidance.",
    nearbyAreas: ["Clifton", "Phase 6", "Phase 8", "PECHS"],
    schools: ["Bay View", "Beaconhouse", "The City School", "KGS nearby demand"],
    subjects: ["School subjects", "O Level", "A Level", "IELTS", "Quran", "English"],
    imageAlt: "Private tutor teaching in a Karachi home",
    primaryCta: { label: "Find Karachi Tutors", to: "/teachers?location=Karachi" },
    popularLinks: [
      { label: "Online tutors Pakistan", to: "/online-tutors-pakistan" },
      { label: "English language support", to: "/english-language" },
      { label: "IELTS tutor Pakistan", to: "/ielts-tutor-pakistan" },
    ],
  }),
  aLevelTutorsGulshanKarachi: areaLandingPage({
    slug: "a-level-home-tutors-gulshan-e-iqbal-karachi",
    city: "Karachi",
    ...
    intro:
      "Students in Gulshan-e-Iqbal Karachi can request A Level tutors for complex concepts, paper strategy, subject revision, and one-to-one Cambridge support.",
    nearbyAreas: ["NIPA", "Johar", "Scheme 33", "Federal B Area"],
    schools: ["Foundation schools", "private colleges", "Beaconhouse", "The City School"],
    subjects: ["Maths", "Physics", "Chemistry", "Biology", "Accounting", "Economics"],
    imageAlt: "A Level tutor helping a Karachi student study at home",
    primaryCta: { label: "Find A Level Tutors", to: "/teachers?location=Karachi&subject=A%20Level" },
    popularLinks: [
      { label: "A Level tutors Pakistan", to: "/a-level-tutors-pakistan" },
      { label: "O and A Level guidance", to: "/o-a-level" },
      { label: "Home tutors DHA Karachi", to: "/home-tutors-dha-karachi" },
    ],
  }),
  femaleTutorsCliftonKarachi: areaLandingPage({
    slug: "female-home-tutors-clifton-karachi",
    city: "Karachi",
    ...
    intro:
      "Parents in Clifton Karachi can request female home tutors for children, school subjects, spoken English, Quran, and steady homework or concept support at home.",
    nearbyAreas: ["Boat Basin", "DHA", "Bath Island", "Civil Lines side"],
    schools: ["Bay View", "Foundation", "The City School", "private academies"],
    subjects: ["Primary classes", "School subjects", "O Level basics", "Quran", "English", "Homework support"],
    imageAlt: "Female tutor teaching a child in Clifton Karachi",
    primaryCta: { label: "Find Female Tutors", to: "/teachers?location=Karachi" },
    popularLinks: [
      { label: "Verified tutors Pakistan", to: "/verified-tutors-pakistan" },
      { label: "K-12 tuition", to: "/k-12" },
      { label: "English tutor Lahore", to: "/english-tutor-lahore" },
  ...
  homeTutorsDGroundFaisalabad: areaLandingPage({
    slug: "home-tutors-d-ground-faisalabad",
    city: "Faisalabad",
    area: "D-Ground Faisalabad",
    focusKey: "home tutors",
    focusLabel: "Home Tutors",
    title: "Home Tutors in D-Ground Faisalabad | Home and Online Tuition",
    description:
      "Find home tutors in D-Ground Faisalabad for school subjects, Matric, FSc, ICS, O Level, IELTS, English, and university support.",
    heading: "Home tutors in D-Ground Faisalabad for school, board and language learning support",
    intro:
      "Families in D-Ground Faisalabad can request home tutors for school classes, board exams, O Level, IELTS, spoken English, and concept revision.",
    nearbyAreas: ["People's Colony", "Madina Town", "Susan Road", "Canal Road"],
    schools: ["Divisional Public School", "Beaconhouse", "The City School", "private colleges"],
    subjects: ["Matric", "FSc", "ICS", "O Level", "IELTS", "English"],
    imageAlt: "Private tutor and student studying at home in Faisalabad",
    primaryCta: { label: "Find Faisalabad Tutors", to: "/teachers?location=Faisalabad" },
    popularLinks: [
      { label: "K-12 tuition", to: "/k-12" },
      { label: "Programming", to: "/programming" },
  ...
  matricTutorsPeoplesColonyFaisalabad: areaLandingPage({
    slug: "matric-home-tutors-peoples-colony-faisalabad",
    city: "Faisalabad",
    ...
    intro:
      "Students in People's Colony Faisalabad can find Matric home tutors for board subjects, chapter-wise revision, paper practice, and one-to-one support before exams.",
    nearbyAreas: ["D-Ground", "Susan Road", "Madina Town", "Canal Road"],
    schools: ["DPS", "MC schools", "private academies", "college feeders"],
    subjects: ["Maths", "Physics", "Chemistry", "Biology", "English", "Urdu"],
    imageAlt: "Matric student studying with tutor in Faisalabad home",
    primaryCta: { label: "Find Matric Tutors", to: "/teachers?location=Faisalabad" },
    popularLinks: [
      { label: "K-12 support", to: "/k-12" },
      { label: "Home tutors D-Ground Faisalabad", to: "/home-tutors-d-ground-faisalabad" },
      { label: "Verified tutors", to: "/verified-tutors-pakistan" },
    ],
  }),
  femaleTutorsCanalRoadFaisalabad: areaLandingPage({
    slug: "female-home-tutors-canal-road-faisalabad",
    city: "Faisalabad",
    ...
    intro:
      "Parents on Canal Road Faisalabad can request female home tutors for children, girls, school subjects, Quran, spoken English, and consistent homework guidance.",
    nearbyAreas: ["Madina Town", "D-Ground", "People's Colony", "Satiana Road"],
    schools: ["private schools", "Beaconhouse", "The City School", "local colleges"],
    subjects: ["Primary classes", "Matric", "FSc", "Quran", "English", "Homework support"],
    imageAlt: "Female tutor helping a child study at home in Faisalabad",
    primaryCta: { label: "Find Female Tutors", to: "/teachers?location=Faisalabad" },
    popularLinks: [
      { label: "Quran tutor with Tajweed", to: "/quran-tutor-with-tajweed" },
      { label: "K-12 tuition", to: "/k-12" },
      { label: "Home tutors D-Ground Faisalabad", to: "/home-tutors-d-ground-faisalabad" },
  ...
  homeTutorsGulgashtMultan: areaLandingPage({
    slug: "home-tutors-gulgasht-multan",
    city: "Multan",
    ...
    intro:
      "Families in Gulgasht Multan can request home tutors for school classes, board subjects, O Level, Quran, IELTS, English, and exam revision support.",
    nearbyAreas: ["Bosan Road", "Cantt", "Shah Rukn-e-Alam", "New Multan"],
    schools: ["Bloomfield Hall", "Beaconhouse", "The City School", "private colleges"],
    subjects: ["Matric", "FSc", "O Level", "IELTS", "Quran", "English"],
    imageAlt: "Home tutor guiding a student in Multan",
    primaryCta: { label: "Find Multan Tutors", to: "/teachers?location=Multan" },
    popularLinks: [
      { label: "IELTS tutor Pakistan", to: "/ielts-tutor-pakistan" },
      { label: "Quran and Tajweed", to: "/quran-tajweed" },
      { label: "Career roadmap", to: "/career-roadmap" },
  ...
  quranTutorsCanttMultan: areaLandingPage({
    slug: "quran-home-tutors-cantt-multan",
    city: "Multan",
    area: "Cantt Multan",
    ...
    intro:
      "Families in Cantt Multan can request Quran tutors for children and adults who need Tajweed correction, Nazra, fluency, and steady recitation practice at home or online.",
    nearbyAreas: ["Gulgasht", "Askari", "Bosan Road", "Old Cantt side"],
    schools: ["Army Public style demand", "private schools", "academies", "community demand"],
    subjects: ["Nazra", "Tajweed", "Makharij", "Quran reading", "Duas", "Revision"],
    imageAlt: "Quran tutor teaching a student in Multan Cantt",
    primaryCta: { label: "Find Quran Tutors", to: "/teachers?location=Multan&subject=Quran" },
    popularLinks: [
      { label: "Quran tutor with Tajweed", to: "/quran-tutor-with-tajweed" },
      { label: "Quran and Tajweed", to: "/quran-tajweed" },
      { label: "Home tutors Gulgasht Multan", to: "/home-tutors-gulgasht-multan" },
    ],
  }),
  englishTutorsBosanRoadMultan: areaLandingPage({
    slug: "english-language-tutors-bosan-road-multan",
    city: "Multan",
    ...
    intro:
      "Students and professionals on Bosan Road Multan can request English tutors for spoken English, grammar improvement, writing practice, school support, and IELTS-related preparation.",
    nearbyAreas: ["Gulgasht", "Shah Rukn-e-Alam", "New Multan", "Cantt"],
    schools: ["Bahauddin Zakariya area demand", "private schools", "colleges", "academies"],
    subjects: ["Spoken English", "Grammar", "Writing", "Vocabulary", "Interview practice", "IELTS basics"],
    imageAlt: "English tutor helping a student practise speaking in Multan",
    primaryCta: { label: "Find English Tutors", to: "/teachers?location=Multan&subject=English" },
    popularLinks: [
      { label: "English language", to: "/english-language" },
      { label: "IELTS tutor Pakistan", to: "/ielts-tutor-pakistan" },
      { label: "Study abroad support", to: "/study-abroad" },
